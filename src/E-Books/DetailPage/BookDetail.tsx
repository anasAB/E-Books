...
const BookDetail = () => {
  ...
  return (
    <div>
      <div className="top">
        <div className="">
          <img
            ...
            src={selectedBookDetail.volumeInfo.imageLinks.smallThumbnail}
            alt={selectedBookDetail.volumeInfo.subtitle}
          />
        </div>
        ...
        <div className="top_info">
          ...
          {selectedBookDetail.saleInfo.offers &&
            `Discount:` +
              calculateSavings(
                selectedBookDetail.saleInfo?.offers[0].listPrice.amountInMicros,
                selectedBookDetail.saleInfo.offers[0].retailPrice.amountInMicros
              )}
        </div>
      ...
      <button className="card-button" onClick={closeHandler}>
        BACK
      </button>
    </div>
  )
